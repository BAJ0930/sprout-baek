...
<p style="font-size:16px; color:#d50c0c;">EMS Weight / Regional Fee</p>
...
<tbody>
<?
	$query = sql_query(" SELECT EPCODE, EPWEIGHT, EPPRICE FROM nEMSPay WHERE EPCODE = '" . $code ."' ORDER BY EPIDX ASC ");
