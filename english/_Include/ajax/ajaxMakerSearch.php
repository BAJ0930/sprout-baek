...
<?
		$sql = "Select *  from 2011_makerInfo where MKdeleted=0 and MKshop='1000u' ";
		if($inKeyword)$sql.=" and MKkname like '%" . $inKeyword . "%' ";
		...
		while($rs=sql_fetch_array($makerResult))
		{
			...
			echo "	<a href='javascript:fnAjaxSearchSelected(\"" . $rs["IDX"] . "#$#" . $rs["MKkname"] . "\")'>" . $rs["MKkname"] . "</a>";
			echo "	</td>";
			echo "</tr>";
		}//-- end Loop
